...
- (void)refreshBottomToolBarStatus {
    ...
    _previewButton.enabled = tzImagePickerVc.selectedModels.count >= ImageLeton.minCount;
    _okButton.enabled = tzImagePickerVc.selectedModels.count >= ImageLeton.minCount || tzImagePickerVc.alwaysEnableDoneBtn;
    
    _numberImageView.hidden = tzImagePickerVc.selectedModels.count+1 <= ImageLeton.minCount;
    _numberLable.hidden = tzImagePickerVc.selectedModels.count+1 <= ImageLeton.minCount;
    _numberLable.text = [NSString stringWithFormat:@"%zd",tzImagePickerVc.selectedModels.count];
